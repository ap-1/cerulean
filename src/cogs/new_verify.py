...
class NewVerify(commands.Cog):
    ...
    @app_commands.command(
        name="verify_andrewid", description="Verify yourself with your AndrewID."
    )
    @app_commands.guilds(Meta.SERVER.value)
    @app_commands.guild_only()
    async def verify_andrewid(self, interaction: discord.Interaction):
...
async def setup(bot: commands.Bot):
    await bot.add_cog(NewVerify(bot))
